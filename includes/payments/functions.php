...
function cf7rzp_create_order() {
    ...
    if( function_exists('cf7rzppa_admin_rzp_order_data') )
        $data = apply_filters("cf7rzp_admin_rzp_order_data", $data, $cf7_id, $form_data);
...
function cf7rzp_prefix_footer_code() {
    $loader_img = CF7RZP_DIR_URL.'assets/img/loader-cod-trans-65.gif';
